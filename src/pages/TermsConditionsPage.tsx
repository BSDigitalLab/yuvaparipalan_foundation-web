...
import { TERMS_CONDITIONS_DATA } from '../data/termsConditionsData';
...
export const TermsConditionsPage: React.FC = () => {
  ...
  return (
    <>
      <SEOHead
        title="Terms & Conditions | Yuvaparipalan Foundation"
        description="Official Terms & Conditions and Governance Standard of Yuvaparipalan Foundation, a Section 8 Not-for-Profit organization."
        canonicalUrl="https://www.yuvaparipalan.org/terms-and-conditions"
      />
      ...
      <div className="min-h-screen bg-[#f8faf8] text-slate-900 selection:bg-emerald-500 selection:text-white pb-20 relative overflow-hidden">
        ...
        <div 
          ...
          style={{
            background: 'radial-gradient(circle, rgba(217, 119, 6, 0.25) 0%, rgba(16, 185, 129, 0.08) 50%, transparent 80%)',
            filter: 'blur(80px)',
          }}
        />

        {/* HERO HEADER */}
        <section className="relative pt-24 pb-12 sm:pt-32 sm:pb-16 bg-gradient-to-b from-amber-50/60 via-[#f8faf8] to-[#f8faf8] border-b border-emerald-900/10 overflow-hidden">
          <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-10 relative z-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              <div className="lg:col-span-7 space-y-4 text-left">
                <FadeIn direction="up">
                  <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-100/90 text-amber-950 border border-amber-300 text-xs font-mono font-bold uppercase tracking-wider shadow-sm">
                  ...
                  <div className="p-5 sm:p-6 rounded-3xl bg-white border border-emerald-900/10 shadow-lg space-y-3.5 text-left relative overflow-hidden">
                    ...
                    <div className="flex items-center gap-3 border-b border-slate-100 pb-3">
                      ...
                      <div>
                        ...
                        <p className="text-[11px] text-amber-800 font-mono font-semibold">{data.orgDetails.type}</p>
                      </div>
                    </div>
        ...
        <section className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-10 pt-8 sm:pt-12 relative z-10">
          <main className="space-y-6 text-left">
            {data.sections.map((section) => (
              ...
              >
                <div className="space-y-4">
                  ...
                  {/* Contact Info Detail for Section 19 */}
                  {section.id === 'contact-and-grievance-redressal' && (
            ...
            <div className="p-6 sm:p-8 rounded-3xl bg-white border border-emerald-900/10 shadow-md flex flex-col sm:flex-row items-center justify-between gap-5 text-center sm:text-left">
              <div>
                <h3 className="font-heading font-extrabold text-base text-slate-950">Privacy Policy Standard</h3>
                <p className="text-xs text-slate-600 mt-1">Read how Yuvaparipalan Foundation safeguards personal data and student privacy.</p>
              </div>
              <Link
                to="/privacy-policy"
                className="px-6 py-3 rounded-2xl bg-amber-700 hover:bg-amber-800 text-white text-xs font-mono font-bold tracking-wider uppercase transition-all shadow-md shrink-0 hover:scale-105"
              >
                View Privacy Policy
              </Link>
            </div>
